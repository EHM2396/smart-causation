      ...
      <table width="560" cellpadding="0" cellspacing="0"
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#4F46E5 0%,#4338CA 100%);padding:28px 40px;">
            <img src="{_FRONTEND_URL}/brand/Logo-blanco.webp"
                 alt="{APP_NAME}"
                 width="130"
                 style="display:block;height:auto;max-height:40px;object-fit:contain;" />
            <p style="margin:8px 0 0;font-size:12px;color:#c7d2fe;">{APP_TAGLINE}</p>
          </td>
        </tr>
